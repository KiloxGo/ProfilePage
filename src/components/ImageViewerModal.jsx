            ...
            <HStack spacing={2}>
              {scale !== 1 && (
                <IconButton
                  ...
                  _hover={{
                    bg: `${PROFILE_CONFIG.colors.primary}15`,
              ...
              <HStack
                ...
                sx={{
                  ...
                  "&::-webkit-scrollbar-thumb": {
                    background: "rgba(54,89,185,0.35)",
                    borderRadius: "3px",
                  },
                }}
              >
                {images.map((image, index) => {
                  ...
                  return (
                    <Box
                      ...
                      border={
                        active
                          ? `2px solid ${PROFILE_CONFIG.colors.primary}`
                    ...
                    >
                      ...
                      {active && (
                        <Box
                          position="absolute"
                          inset={0}
                          boxShadow={`inset 0 0 0 2px ${PROFILE_CONFIG.colors.primary}`}
                        />
                      )}
                    </Box>
                  );
